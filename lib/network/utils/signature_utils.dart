...
class SignatureUtils {
  ...
  /// 构建签名字符串
  static String _buildSignString(RequestOptions options, int timestamp, String secretKey) {
    ...
    if (options.data != null) {
      if (options.data is Map) {
        bodyString = _buildSortedQueryString(options.data as Map<String, dynamic>);
