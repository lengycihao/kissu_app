...
class ScreenAdaptation {
  // 设计稿基准尺寸
  static const double designWidth = 1125.0;
  ...
  static double get dynamicBackgroundWidth =>
      screenHeight / designHeight * designWidth;
  ...
  /// 基于动态背景宽度缩放X坐标
  static double scaleXByDynamicWidth(double value) =>
      value * (dynamicBackgroundWidth / designWidth);
  ...
  /// 缩放位置（使用宽度比例）
  static Offset scalePosition(Offset position) =>
      Offset(scaleX(position.dx), scaleY(position.dy));
